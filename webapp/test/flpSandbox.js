		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "InvoicesList",
									"targetURL": "#miguelmafrinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"miguelmafrinvoices-display": {
								"semanticObject": "miguelmafrinvoices",
								"action": "display",
								"description": "InvoicesList",
								"title": "InvoicesList",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=miguelmafr.invoices",
									"url": sap.ui.require.toUrl("miguelmafr/invoices")
								}
							}
						}
					}
